...
## Project Structure
    ...
    ├── testapiautostorybo_126861  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_126861`
...
2. Clone this repo and `cd testapiautostorybo_126861`
